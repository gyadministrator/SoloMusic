...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*先获取配置信息*/
        try {
            config = (ZxingConfig) Objects.requireNonNull(getIntent().getExtras()).get(Constant.INTENT_ZXING_CONFIG);
        } catch (Exception e) {
        ...
        immersionBar.statusBarColor(R.color.btn_color);
        //immersionBar.navigationBarColor(R.color.bottom_color);
        immersionBar.init();
