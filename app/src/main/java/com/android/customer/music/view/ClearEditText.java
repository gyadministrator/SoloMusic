...
import com.android.customer.music.utils.ValidateUtils;

/**
 * Description: 带删除按钮的EditText 适配银行卡输入
 * Created by gy(1984629668@qq.com)
 * Created Time on 2019/12/8 11:20
 */
...
public class ClearEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        // 获取自定义属性
        drawableClear = getResources().getDrawable(R.drawable.close);
        updateIconClear();
