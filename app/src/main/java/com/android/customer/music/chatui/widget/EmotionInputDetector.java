...
import com.android.customer.music.chatui.util.AudioRecoderUtils;
import com.android.customer.music.chatui.util.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                messageInfo.setMsgType(MessageInfo.TYPE_TEXT);
    ...
    public EmotionInputDetector bindToVoiceButton(View voiceButton) {
        voiceButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //申请权限
                if (ContextCompat.checkSelfPermission(mActivity, android.Manifest.permission.RECORD_AUDIO)
    ...
    public EmotionInputDetector build() {
        ...
        mAudioRecoderUtils.setOnAudioStatusUpdateListener(new AudioRecoderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onStop(long time, String filePath) {
                ...
                messageInfo.setMsgType(MessageInfo.TYPE_VOICE);
                EventBus.getDefault().post(messageInfo);
            }
