...
import com.android.customer.music.view.ILrcView;
...
public class LrcView extends View implements ILrcView {
     ...
     **/
    private int mMinSeekLineTextSize = 23;
    /**
     * 拖动歌词时，展示当前高亮歌词的时间的字体大小最大值
     **/
    private int mMaxSeekLineTextSize = 28;

    /**
     * 歌词字体大小默认值
     **/
    private int mLrcFontSize = 65;    // font size of lrc
    /**
     * 歌词字体大小最小值
     **/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mHignlightRow < mLrcRows.size()) {
            ...
            highlightRowY = height / 2 - mLrcFontSize;
            mPaint.setColor(mHignlightRowColor);
            mPaint.setTextSize(mLrcFontSize);
            mPaint.setTextAlign(Align.CENTER);
