...
public class EmojiDao {
     ...
     * @return 存储数据库的地址
     */
    private static String CopySqliteFileFromRawToDatabases(Context context,String SqliteFileName) throws IOException {
            ...
            try {
                ...
                if (context.getClass().getClassLoader() != null) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                        inputStream = Objects.requireNonNull(context.getClass().getClassLoader()).getResourceAsStream("assets/" + SqliteFileName);
                    } else {
