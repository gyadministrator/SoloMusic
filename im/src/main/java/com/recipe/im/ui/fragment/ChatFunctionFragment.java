...
public class ChatFunctionFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView chat_function_photo = rootView.findViewById(R.id.chat_function_photo);
        TextView chat_function_photograph = rootView.findViewById(R.id.chat_function_photograph);
        chat_function_photo.setOnClickListener(new View.OnClickListener() {
        ...
        chat_function_photograph.setOnClickListener(new View.OnClickListener() {
            @RequiresApi(api = Build.VERSION_CODES.KITKAT)
            @Override
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(Objects.requireNonNull(getActivity()),
